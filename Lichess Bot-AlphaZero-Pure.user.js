...
function setupWebSocketHandlers(wrappedWebSocket) {
    ...
    wrappedWebSocket.addEventListener("message", function (event) {
        ...
        if (message.d && typeof message.d.fen === "string" && typeof message.v === "number") {
            ...
            // CRITICAL: Determine color by ATTEMPTING to move
            // Don't guess color - let Lichess tell us via move acceptance
            if (myColor === null) {
                // We don't know our color yet
                // ALWAYS try to calculate - color will be determined when move is sent
                console.log(`🎯 Color unknown (v=${message.v}) - calculating to determine our side...`);
                calculateMove();
            } else {
