...
function calculateMove() {
    ...
    // Set a safety timeout to prevent infinite calculation
    const safetyTimeout = setTimeout(() => {
        if (isCalculating) {
            console.warn("⚠️ Engine calculation timeout! Forcing stop...");
            chessEngine.postMessage("stop");
            isCalculating = false;
        }
    }, thinkTime + 5000); // 5 seconds extra safety margin
